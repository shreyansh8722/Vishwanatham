...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-heritage-paper font-body text-heritage-charcoal selection:bg-heritage-rudraksha selection:text-white">
      <Navbar />

      {/* --- HERO SECTION --- */}
      <div className="relative h-[65vh] overflow-hidden">
        <div className="absolute inset-0 bg-heritage-charcoal/30 z-10" />
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-center text-white px-6">
          <motion.span 
            ...
            className="text-xs font-bold font-body uppercase tracking-[0.3em] mb-4 bg-heritage-charcoal/20 px-4 py-2 backdrop-blur-sm"
          >
            Since 1985
          </motion.span>
          <motion.h1 
            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
            className="font-heading text-5xl md:text-7xl font-medium leading-tight"
          >
      ...
      <section className="py-24 px-6 md:px-12 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <span className="text-heritage-gold text-xs font-bold uppercase tracking-[0.2em] block">01. The Origin</span>
            <h2 className="font-heading text-4xl md:text-5xl text-heritage-charcoal leading-tight">
              "We don't just weave cloth; <br/> we weave history."
            </h2>
            <div className="space-y-6 text-heritage-grey text-lg leading-relaxed font-light">
              <p>
          ...
          <div className="relative">
            <div className="aspect-[4/5] bg-heritage-sand overflow-hidden rounded-sm">
      ...
      {/* --- CHAPTER 2: THE CITY --- */}
      <section className="bg-heritage-sand/30 py-24 px-6 md:px-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1">
             <div className="aspect-square bg-white p-2 border border-heritage-mist">
               <img src={CITY_IMG} alt="Varanasi Ghats" className="w-full h-full object-cover" />
             </div>
          </div>
          <div className="order-1 md:order-2 space-y-6">
            <span className="text-heritage-gold text-xs font-bold uppercase tracking-[0.2em] block">02. The Muse</span>
            <h2 className="font-heading text-4xl md:text-5xl text-heritage-charcoal leading-tight">
